    ...
    <>
        <div style={{ paddingBottom: '10rem' }}>
            ...
            <div className="Container-Modes-De-Jeu" style={{ display: ChasseGros_IsOpen ? 'block' : 'none' }} id="ChasseGros_Mode">
                <p>
                    Le joueur qui joue les aliens devra choisir 5 caractéristiques dans la <strong style={{fontSize:'1.25rem'}}>Table Caractéristiques</strong> ci-dessous (sans compter la taille qui est obligatoire).<br />
